...
void SmaccStateMachineInfo::assembleSMStructureMessage(ISmaccStateMachine * sm)
{
  ...
  {
    smacc_msgs::msg::SmaccState stateMsg;
    ...
    {
      smacc_msgs::msg::SmaccTransition transitionMsg;
    ...
    std::map<const std::type_info *, std::vector<smacc::ClientBehaviorInfoEntry *>>
    ...
    {
      smacc_msgs::msg::SmaccOrthogonal orthogonalMsg;
    ...
    if (SmaccStateInfo::stateReactorsInfo.count(statetid) > 0)
    {
      ...
      for (auto & srinfo : SmaccStateInfo::stateReactorsInfo[statetid])
      {
        ...
        for (auto & tev : srinfo->sourceEventTypes)
        {
          ...
          smacc_msgs::msg::SmaccEvent event;
