...
public:
    ...
    virtual void initiate_impl() override
    {
        ...
        RCLCPP_INFO(getNode()->get_logger(), "[SmaccStateMachine] Introspecting state machine via typeWalker");
        ...
        RCLCPP_INFO(getNode()->get_logger(), "[SmaccStateMachine] Initializing ROS communication mechanisms");
        this->onInitialized();
