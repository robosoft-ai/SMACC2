...
{
// STATE DECLARATION
struct StiASequenceInspire3 : smacc2::SmaccState<StiASequenceInspire3, SsASequence3>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiASequencePlateau3, SUCCESS>,
