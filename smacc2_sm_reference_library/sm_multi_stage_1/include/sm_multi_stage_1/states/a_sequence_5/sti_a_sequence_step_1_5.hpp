...
{
// STATE DECLARATION
struct StiASequenceStep15 : smacc2::SmaccState<StiASequenceStep15, SsASequence5>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiASequenceStep25, TIMEOUT>,
    Transition<EvKeyPressN<CbDefaultKeyboardBehavior, OrKeyboard>, StiASequenceStep25, NEXT>
