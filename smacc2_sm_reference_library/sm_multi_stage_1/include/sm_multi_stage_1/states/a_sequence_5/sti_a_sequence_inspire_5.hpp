...
{
// STATE DECLARATION
struct StiASequenceInspire5 : smacc2::SmaccState<StiASequenceInspire5, SsASequence5>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiASequencePlateau5, TIMEOUT>,
    Transition<EvKeyPressN<CbDefaultKeyboardBehavior, OrKeyboard>, StiASequencePlateau5, NEXT>
