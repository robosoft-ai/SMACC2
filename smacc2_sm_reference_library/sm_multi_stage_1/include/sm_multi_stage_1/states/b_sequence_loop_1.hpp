...
// STATE DECLARATION
struct BSequenceLoop1 : smacc2::SmaccState<BSequenceLoop1, MsMode1>
{
public:
  ...
  typedef mpl::list<
    ...
    Transition<EvLoopContinue<BSequenceLoop1>, SsBSequence1, CONTINUELOOP>
  ...
  void onEntry()
  {
    ...
    checkWhileLoopConditionAndThrowEvent(&BSequenceLoop1::loopWhileCondition);
  }
};
}  // namespace sm_multi_stage_1
