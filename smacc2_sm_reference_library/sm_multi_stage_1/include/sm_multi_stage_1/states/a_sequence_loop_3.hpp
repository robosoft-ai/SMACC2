...
// STATE DECLARATION
struct ASequenceLoop3 : smacc2::SmaccState<ASequenceLoop3, MsMode3>
{
public:
  ...
  typedef mpl::list<
     ...
     Transition<EvLoopContinue<ASequenceLoop3>, SsASequence3, CONTINUELOOP>
  ...
  void onEntry()
  {
    ...
    checkWhileLoopConditionAndThrowEvent(&ASequenceLoop3::loopWhileCondition);
  }
};
}  // namespace sm_multi_stage_1
