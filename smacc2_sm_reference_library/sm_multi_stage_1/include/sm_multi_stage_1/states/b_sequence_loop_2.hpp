...
// STATE DECLARATION
struct BSequenceLoop2 : smacc2::SmaccState<BSequenceLoop2, MsMode2>
{
public:
  ...
  typedef mpl::list<
    ...
    Transition<EvLoopContinue<BSequenceLoop2>, SsBSequence2, CONTINUELOOP>
  ...
  void onEntry()
  {
    ...
    checkWhileLoopConditionAndThrowEvent(&BSequenceLoop2::loopWhileCondition);
  }
};
}  // namespace sm_multi_stage_1
