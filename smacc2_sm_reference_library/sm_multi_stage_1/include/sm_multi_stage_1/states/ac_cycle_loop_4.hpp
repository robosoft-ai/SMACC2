...
// STATE DECLARATION
struct ACCycleLoop4 : smacc2::SmaccState<ACCycleLoop4, MsMode4>
{
public:
  ...
  typedef mpl::list<
     ...
     Transition<EvLoopContinue<ACCycleLoop4>, SsACCycle4, CONTINUELOOP>
  ...
  void onEntry()
  {
    ...
    checkWhileLoopConditionAndThrowEvent(&ACCycleLoop4::loopWhileCondition);
  }
};
}  // namespace sm_multi_stage_1
