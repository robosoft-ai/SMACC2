...
// STATE DECLARATION
struct ASequenceLoop5 : smacc2::SmaccState<ASequenceLoop5, MsMode5>
{
public:
  ...
  typedef mpl::list<
     ...
     Transition<EvLoopContinue<ASequenceLoop5>, SsASequence5, CONTINUELOOP>
  ...
  void onEntry()
  {
    ...
    checkWhileLoopConditionAndThrowEvent(&ASequenceLoop5::loopWhileCondition);
  }
};
}  // namespace sm_multi_stage_1
