...
// STATE DECLARATION
struct CMVCycleLoop3 : smacc2::SmaccState<CMVCycleLoop3, MsMode3>
{
public:
  ...
  typedef mpl::list<
    ...
    Transition<EvLoopContinue<CMVCycleLoop3>, SsCMVCycle3, CONTINUELOOP>
  ...
  void onEntry()
  {
    ...
    checkWhileLoopConditionAndThrowEvent(&CMVCycleLoop3::loopWhileCondition);
  }
};
}  // namespace sm_multi_stage_1
