...
// STATE DECLARATION
struct ASequenceLoop2 : smacc2::SmaccState<ASequenceLoop2, MsMode2>
{
public:
  ...
  typedef mpl::list<
     ...
     Transition<EvLoopContinue<ASequenceLoop2>, SsASequence2, CONTINUELOOP>
  ...
  void onEntry()
  {
    ...
    checkWhileLoopConditionAndThrowEvent(&ASequenceLoop2::loopWhileCondition);
  }
};
}  // namespace sm_multi_stage_1
