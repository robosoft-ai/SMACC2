...
// STATE DECLARATION
struct BSequenceLoop3 : smacc2::SmaccState<BSequenceLoop3, MsMode3>
{
public:
  ...
  typedef mpl::list<
    ...
    Transition<EvLoopContinue<BSequenceLoop3>, SsBSequence3, CONTINUELOOP>
  ...
  void onEntry()
  {
    ...
    checkWhileLoopConditionAndThrowEvent(&BSequenceLoop3::loopWhileCondition);
  }
};
}  // namespace sm_multi_stage_1
