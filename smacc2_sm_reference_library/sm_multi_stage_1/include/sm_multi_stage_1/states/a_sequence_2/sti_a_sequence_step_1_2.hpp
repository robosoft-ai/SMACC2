...
{
// STATE DECLARATION
struct StiASequenceStep12 : smacc2::SmaccState<StiASequenceStep12, SsASequence2>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiASequenceStep22, SUCCESS>,
    Transition<EvKeyPressN<CbDefaultKeyboardBehavior, OrKeyboard>, StiASequenceStep22, NEXT>
