...
{
// STATE DECLARATION
struct StiASequenceInspire2 : smacc2::SmaccState<StiASequenceInspire2, SsASequence2>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiASequencePlateau2, SUCCESS>,
    Transition<EvKeyPressN<CbDefaultKeyboardBehavior, OrKeyboard>, StiASequencePlateau2, NEXT>
