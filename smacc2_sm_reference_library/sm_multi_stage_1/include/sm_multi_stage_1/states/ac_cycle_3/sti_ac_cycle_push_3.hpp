...
{
// STATE DECLARATION
struct StiACCyclePush3 : smacc2::SmaccState<StiACCyclePush3, SsACCycle3>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiACCycleLoop3, TIMEOUT>,
    Transition<EvKeyPressP<CbDefaultKeyboardBehavior, OrKeyboard>, StiACCycleRecycle3, PREVIOUS>,
    Transition<EvKeyPressN<CbDefaultKeyboardBehavior, OrKeyboard>, StiACCycleLoop3, NEXT>
