...
{
// STATE DECLARATION
struct StiCSequenceInspire4 : smacc2::SmaccState<StiCSequenceInspire4, SsCSequence4>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiCSequencePlateau4, TIMEOUT>,
    Transition<EvKeyPressN<CbDefaultKeyboardBehavior, OrKeyboard>, StiCSequencePlateau4, NEXT>
