...
{
// STATE DECLARATION
struct StiASequenceStep91 : smacc2::SmaccState<StiASequenceStep91, SsASequence1>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvKeyPressP<CbDefaultKeyboardBehavior, OrKeyboard>, StiASequenceStep81, PREVIOUS>,
