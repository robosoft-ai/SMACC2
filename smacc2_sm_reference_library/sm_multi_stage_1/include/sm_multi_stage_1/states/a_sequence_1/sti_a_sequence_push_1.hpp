...
{
// STATE DECLARATION
struct StiASequencePush1 : smacc2::SmaccState<StiASequencePush1, SsASequence1>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiASequenceLoop1, TIMEOUT>,
    Transition<EvKeyPressP<CbDefaultKeyboardBehavior, OrKeyboard>, StiASequenceRecycle1, PREVIOUS>,
    Transition<EvKeyPressN<CbDefaultKeyboardBehavior, OrKeyboard>, StiASequenceLoop1, NEXT>
