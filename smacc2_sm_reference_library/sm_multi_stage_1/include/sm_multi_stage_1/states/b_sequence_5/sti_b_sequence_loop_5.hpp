...
{
// STATE DECLARATION
struct StiBSequenceLoop5 : smacc2::SmaccState<StiBSequenceLoop5, SsBSequence5>
{
public:
  ...
  {
    auto & superstate = this->context<SsBSequence5>();
  ...
  void onEntry()
  {
    ...
    checkWhileLoopConditionAndThrowEvent(&StiBSequenceLoop5::loopWhileCondition);
  }
};
