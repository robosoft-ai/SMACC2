...
{
// STATE DECLARATION
struct StiCMVCycleInspire2 : smacc2::SmaccState<StiCMVCycleInspire2, SsCMVCycle2>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiCMVCyclePlateau2, SUCCESS>,
