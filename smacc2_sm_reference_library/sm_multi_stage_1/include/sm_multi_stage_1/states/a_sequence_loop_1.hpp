...
// STATE DECLARATION
struct ASequenceLoop1 : smacc2::SmaccState<ASequenceLoop1, MsMode1>
{
public:
  ...
  typedef mpl::list<
    ...
    Transition<EvLoopContinue<ASequenceLoop1>, SsASequence1, CONTINUELOOP>
  ...
  void onEntry()
  {
    ...
    checkWhileLoopConditionAndThrowEvent(&ASequenceLoop1::loopWhileCondition);
  }
};
}  // namespace sm_multi_stage_1
