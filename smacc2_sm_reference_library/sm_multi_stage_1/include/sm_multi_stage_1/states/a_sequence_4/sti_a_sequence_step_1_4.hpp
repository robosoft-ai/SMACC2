...
{
// STATE DECLARATION
struct StiASequenceStep14 : smacc2::SmaccState<StiASequenceStep14, SsASequence4>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiASequenceStep24, TIMEOUT>,
    Transition<EvKeyPressN<CbDefaultKeyboardBehavior, OrKeyboard>, StiASequenceStep24, NEXT>
