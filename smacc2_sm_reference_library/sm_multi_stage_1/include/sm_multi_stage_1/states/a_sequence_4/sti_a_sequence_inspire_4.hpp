...
{
// STATE DECLARATION
struct StiASequenceInspire4 : smacc2::SmaccState<StiASequenceInspire4, SsASequence4>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiASequencePlateau4, TIMEOUT>,
    Transition<EvKeyPressN<CbDefaultKeyboardBehavior, OrKeyboard>, StiASequencePlateau4, NEXT>
