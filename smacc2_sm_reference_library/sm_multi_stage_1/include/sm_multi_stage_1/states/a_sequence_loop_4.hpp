...
// STATE DECLARATION
struct ASequenceLoop4 : smacc2::SmaccState<ASequenceLoop4, MsMode4>
{
public:
  ...
  typedef mpl::list<
     ...
     Transition<EvLoopContinue<ASequenceLoop4>, SsASequence4, CONTINUELOOP>
  ...
  void onEntry()
  {
    ...
    checkWhileLoopConditionAndThrowEvent(&ASequenceLoop4::loopWhileCondition);
  }
};
}  // namespace sm_multi_stage_1
