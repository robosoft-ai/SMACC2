...
{
// STATE DECLARATION
struct StiDSequenceInspire4 : smacc2::SmaccState<StiDSequenceInspire4, SsDSequence4>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StiDSequencePlateau4, TIMEOUT>,
    Transition<EvKeyPressN<CbDefaultKeyboardBehavior, OrKeyboard>, StiDSequencePlateau4, NEXT>
