...
// STATE DECLARATION
struct StCircularPivotMotion : smacc2::SmaccState<StCircularPivotMotion, SmPandaClMoveit2zCbInventory>
{
  ...
  typedef boost::mpl::list<
    Transition<EvCbSuccess<CbCircularPivotMotion, OrArm>, StPause13, SUCCESS>,
