...
{
// STATE DECLARATION
struct StiCMVCyclePush : smacc2::SmaccState<StiCMVCyclePush, SsCMVCycle>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvKeyPressP<CbDefaultKeyboardBehavior, OrKeyboard>, StiCMVCycleRecycle, PREVIOUS>,
