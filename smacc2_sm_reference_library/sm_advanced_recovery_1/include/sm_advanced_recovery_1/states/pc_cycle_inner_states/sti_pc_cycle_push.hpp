...
{
// STATE DECLARATION
struct StiPCCyclePush : smacc2::SmaccState<StiPCCyclePush, SsPCCycle>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvKeyPressP<CbDefaultKeyboardBehavior, OrKeyboard>, StiPCCycleRecycle, PREVIOUS>,
