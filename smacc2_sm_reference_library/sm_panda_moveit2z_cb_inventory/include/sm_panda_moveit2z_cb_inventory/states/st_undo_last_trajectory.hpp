...
// STATE DECLARATION
struct StUndoLastTrajectory : smacc2::SmaccState<StUndoLastTrajectory, SmPandaMoveit2zCbInventory>
{
  ...
  typedef boost::mpl::list<
      Transition<EvCbSuccess<CbUndoLastTrajectory, OrArm>, StPause11, SUCCESS>,
