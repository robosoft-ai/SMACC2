...
public:
  ...
  typedef mpl::list<
    ...
    Transition<EvLoopEnd<StiFPatternStartLoop<SsFPattern1>>, StNavigateArtGalleryWaypointsX, ENDLOOP>  //,
...
#include <sm_dancebot_artgallery_ue/states/f_pattern_states/sti_fpattern_forward_1.hpp>
#include <sm_dancebot_artgallery_ue/states/f_pattern_states/sti_fpattern_forward_2.hpp>
#include <sm_dancebot_artgallery_ue/states/f_pattern_states/sti_fpattern_loop_start.hpp>
#include <sm_dancebot_artgallery_ue/states/f_pattern_states/sti_fpattern_return_1.hpp>
#include <sm_dancebot_artgallery_ue/states/f_pattern_states/sti_fpattern_rotate_1.hpp>
#include <sm_dancebot_artgallery_ue/states/f_pattern_states/sti_fpattern_rotate_2.hpp>
