...
{
// STATE DECLARATION
struct StiSPatternForward4Retry : public smacc2::SmaccState<StiSPatternForward4Retry, SS>
{
  ...
  typedef mpl::list<
    ...
    Transition<EvCbSuccess<CbRetry<CbNavigateForward>, OrNavigation>, StiSPatternLoopStart>
