...
namespace sm_husky_barrel_search_1
{
    ...
    // STATE DECLARATION
    struct StExplore1 : smacc2::SmaccState<StExplore1, SmHuskyBarrelSearch1>
    {
        using SmaccState::SmaccState;

        // TRANSITION TABLE
        typedef mpl::list<
              Transition<EvCbSuccess<CbNavigateNextWaypoint, OrNavigation>, StExplore2, SUCCESS>,
              Transition<EvCbFailure<CbNavigateNextWaypoint, OrNavigation>, StExplore1, ABORT>
