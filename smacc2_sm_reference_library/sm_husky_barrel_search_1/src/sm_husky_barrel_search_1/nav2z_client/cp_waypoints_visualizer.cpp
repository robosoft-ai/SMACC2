...
namespace cl_nav2z
{
  ...
  CpWaypointsVisualizer::CpWaypointsVisualizer(rclcpp::Duration duration)
    : ISmaccUpdatable(duration)
  {
  ...
  void CpWaypointsVisualizer::createMarkerLabel(const geometry_msgs::msg::Pose& waypoint, std::string label, visualization_msgs::msg::Marker& marker)
  {
  ...
  void CpWaypointsVisualizer::createMarker(const geometry_msgs::msg::Pose& waypoint, visualization_msgs::msg::Marker& marker)
  {
      marker.header.frame_id = frameid;
      marker.header.stamp = getNode()->now();
      marker.ns = "waypoints";
