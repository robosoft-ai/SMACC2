...
namespace smacc2
{
  class LedSettingPrivate
  {
    ...
    public: gazebo::transport::PublisherPtr pubVisual;
...
LedSetting::LedSetting(
  ...
  : FlashLightSetting(_sdf, _model, _currentTime, rosnode),
...
//////////////////////////////////////////////////
void LedSetting::InitPubVisual(const gazebo::transport::PublisherPtr &_pubVisual)
{
  // The PublisherPtr
...
{
  return std::make_shared<LedSetting>(_sdf, _model, _currentTime, node);
}
