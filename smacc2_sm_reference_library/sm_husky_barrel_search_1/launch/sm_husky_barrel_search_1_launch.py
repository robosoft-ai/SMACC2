...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            sm_husky_barrel_search_1_dir, "params", "nav2z_client", "nav2_params.yaml"
        ),
    ...
    declare_bt_xml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            sm_husky_barrel_search_1_dir, "params", "nav2z_client", "navigation_tree.xml"
        ),
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        "map",
        default_value=os.path.join(sm_husky_barrel_search_1_dir, "maps", "turtlebot3_world.yaml"),
    ...
    rviz_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(sm_husky_barrel_search_1_launch_dir, "rviz_launch.py")
        ),
    ...
    bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(sm_husky_barrel_search_1_launch_dir, "bringup_launch.py")
        ),
        launch_arguments={
            "namespace": namespace,
    ...
    sm_husky_barrel_search_1_node = Node(
        ...
        executable="sm_husky_barrel_search_1_node",
        ...
        parameters=[
            os.path.join(
                ...
                "params/sm_husky_barrel_search_1_config.yaml",
            ),
            os.path.join(
                get_package_share_directory("sm_husky_barrel_search_1"),
