...
struct StAcquireSensors : smacc2::SmaccState<StAcquireSensors, MsDanceBotRunMode>
{
  ...
  typedef mpl::list<
    ...
    // 
    Transition<EvAllGo<SrAllEventsGo, SrAcquireSensors>, StNavigateOfficeWaypointsX, ON_SENSORS_AVAILABLE>,
  ...
  {
    configure_orthogonal<OrNavigation, sm_dancebot_office_ue::CbLoadWaypointsFile>("waypoints_office", "sm_dancebot_office_ue");
