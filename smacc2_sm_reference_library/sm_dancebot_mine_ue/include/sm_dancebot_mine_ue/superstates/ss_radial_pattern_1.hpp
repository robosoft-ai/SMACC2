...
using namespace sm_dancebot_mine_ue::radial_motion_states;
...
public:
  ...
  // TRANSITION TABLE
  typedef mpl::list<
    Transition<EvLoopEnd<StiRadialLoopStart>, StNavigateMineWaypointsX, ENDLOOP>  //,
...
#include <sm_dancebot_mine_ue/states/radial_motion_states/sti_radial_end_point.hpp>
#include <sm_dancebot_mine_ue/states/radial_motion_states/sti_radial_loop_start.hpp>
#include <sm_dancebot_mine_ue/states/radial_motion_states/sti_radial_return.hpp>
#include <sm_dancebot_mine_ue/states/radial_motion_states/sti_radial_rotate.hpp>
}  // namespace SS1
}  // namespace sm_dancebot_mine_ue
