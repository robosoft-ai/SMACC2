...
def generate_launch_description():
    ...
    sm_dance_bot_dir = get_package_share_directory("sm_dancebot_mine_ue")
    ...
    sm_dance_bot_node = Node(
        package="sm_dancebot_mine_ue",
        executable="sm_dancebot_mine_ue_node",
        name="SmDanceBotMineUE",
        output="screen",
        prefix=xtermprefix + " gdb -ex run --args",
        parameters=[
            os.path.join(
                get_package_share_directory("sm_dancebot_mine_ue"),
                "params/sm_dancebot_mine_ue_config.yaml",
            )
        ],
        remappings=[
