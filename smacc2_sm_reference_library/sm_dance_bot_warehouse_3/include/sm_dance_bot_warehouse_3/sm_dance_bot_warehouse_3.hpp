...
using namespace sm_dance_bot_warehouse_3::cl_lidar;
using namespace sm_dance_bot_warehouse_3::cl_service3;
using namespace sm_dance_bot_warehouse_3::cl_string_publisher;
using namespace sm_dance_bot_warehouse_3::cl_temperature_sensor;
using namespace sm_dance_bot_warehouse_3::cl_led;
