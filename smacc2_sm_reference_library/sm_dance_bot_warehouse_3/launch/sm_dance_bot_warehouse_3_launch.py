...
def generate_launch_description():
    ...
    sm_dance_bot_warehouse_3_launch_dir = os.path.join(sm_dance_bot_warehouse_3_dir, "launch")
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            sm_dance_bot_warehouse_3_dir, "params", "nav2z_client", "nav2_params.yaml"
        ),
    ...
    declare_bt_xml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            sm_dance_bot_warehouse_3_dir, "params", "nav2z_client", "navigation_tree.xml"
        ),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        "rviz_config_file",
        default_value=os.path.join(sm_dance_bot_warehouse_3_dir, "rviz", "nav2_default_view.rviz"),
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        "map",
        default_value=os.path.join(sm_dance_bot_warehouse_3_dir, "maps", "turtlebot3_world.yaml"),
    ...
    rviz_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(sm_dance_bot_warehouse_3_launch_dir, "rviz_launch.py")
        ),
    ...
    bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(sm_dance_bot_warehouse_3_launch_dir, "bringup_launch.py")
        ),
        launch_arguments={
            "namespace": namespace,
    ...
    #     PythonLaunchDescriptionSource(os.path.join(sm_dance_bot_warehouse_3_launch_dir, "husky_gazebo.launch.py")),
    #     launch_arguments={'world_path': os.path.join(sm_dance_bot_warehouse_3_dir, "worlds", "ridgeback_race_empty.world")}.items()
    # )

    gazebo_simulator = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(sm_dance_bot_warehouse_3_launch_dir, "gazebo_launch.py")
        ),
    ...
    sm_dance_bot_warehouse_3_node = Node(
        ...
        remappings=[
            ...
            # ("/sm_dance_bot_warehouse_3_2/odom_tracker/odom_tracker_path", "/odom_tracker_path"),
            # ("/sm_dance_bot_warehouse_3_2/odom_tracker/odom_tracker_stacked_path", "/odom_tracker_path_stacked")
        ],
    ...
    ld.add_action(sm_dance_bot_warehouse_3_node)
