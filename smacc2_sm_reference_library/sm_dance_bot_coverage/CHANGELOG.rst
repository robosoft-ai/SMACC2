^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package sm_dance_bot_coverage
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* Feature/galactic rolling merge (#288)
  ...
  * progress in aws navigation demo
  * minor format
  * navigation parameters fixes on sm_dance_bot_coverage
  * minor format
  ...
  * minor hotfix
  * sm_dance_bot_coverage visualizing turtlebot3 (#101)
  * Feature/dance bot launch gz lidar choice (#102)
  * sm_dance_bot_coverage visualizing turtlebot3
  ...
  * going forward in testing sm_dance_bot_coverage introducing slam pausing/resuming funcionality
  * feature/more_sm_dance_bot_fixes
  * minor format
  * minor (#124)
  Co-authored-by: Ubuntu 20-04-02-amd64 <brett@robosoft.ai>
  * more changes in sm_dance_bot_coverage (#125)
  * Move method after the method it calls. Otherwise recursion could happen. (#126)
  * Feature/dance bot s pattern (#128)
  * more changes in sm_dance_bot_coverage
  * polishing sm_dance_bot_coverage and s-pattern
  * noticed typo
  Finnaly > Finally
  * Feature/dance bot s pattern (#129)
  * more changes in sm_dance_bot_coverage
  * polishing sm_dance_bot_coverage and s-pattern
  * more refinement in sm_dance_bot_coverage
  ...
  * progress in the sm_dance_bot_coverage tests (#135)
  ...
  * repo dependency
  * husky launch file in sm_dance_bot_coverage
  ...
  * fixing sm_dance_bot_coverage examples
