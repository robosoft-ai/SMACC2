...
public:
  ...
  typedef mpl::list<
    ...
    Transition<EvLoopEnd<StiFPatternStartLoop<SsFPattern1>>, StForwardAisle, ENDLOOP>  //,
  ...
  static constexpr float pitch_lenght_meters() { return 1.9; }
...
#include <sm_dance_bot_warehouse_2/states/f_pattern_states/sti_fpattern_forward_1.hpp>
#include <sm_dance_bot_warehouse_2/states/f_pattern_states/sti_fpattern_forward_2.hpp>
#include <sm_dance_bot_warehouse_2/states/f_pattern_states/sti_fpattern_loop_start.hpp>
#include <sm_dance_bot_warehouse_2/states/f_pattern_states/sti_fpattern_return_1.hpp>
#include <sm_dance_bot_warehouse_2/states/f_pattern_states/sti_fpattern_rotate_1.hpp>
#include <sm_dance_bot_warehouse_2/states/f_pattern_states/sti_fpattern_rotate_2.hpp>
