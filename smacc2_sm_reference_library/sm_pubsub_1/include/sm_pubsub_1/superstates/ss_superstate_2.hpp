...
using namespace sm_pubsub_1::inner_states;
...
#include <sm_pubsub_1/states/inner_states/sti_state_1.hpp>
#include <sm_pubsub_1/states/inner_states/sti_state_2.hpp>
#include <sm_pubsub_1/states/inner_states/sti_state_3.hpp>
