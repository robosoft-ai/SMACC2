...
def generate_launch_description():
    ...
    launch_dir = os.path.join(sm_dance_bot_warehouse_4_dir, "launch")
    ...
    declare_world_cmd = DeclareLaunchArgument(
        "world",
        default_value=os.path.join(sm_dance_bot_warehouse_4_dir, "worlds", "industrial_sim.world"),
    ...
    declare_urdf = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            sm_dance_bot_warehouse_4_dir, "models", "turtlebot3_waffle", "model.sdf"
        ),
        description="",
    )
