...
#include <sm_dance_bot_warehouse_4/clients/cl_led/client_behaviors/cb_led_off.hpp>
#include <sm_dance_bot_warehouse_4/clients/cl_led/client_behaviors/cb_led_on.hpp>

#include <sm_dance_bot_warehouse_4/clients/cl_lidar/client_behaviors/cb_lidar_sensor.hpp>
#include <sm_dance_bot_warehouse_4/clients/cl_lidar/components/cp_forward_obstacle_detector.hpp>
#include <sm_dance_bot_warehouse_4/clients/cl_nav2z/behaviors/cb_pure_spinning.hpp>

#include <sm_dance_bot_warehouse_4/clients/cl_nav2z/components/cp_square_shape_bondary.hpp>

#include <sm_dance_bot_warehouse_4/clients/cl_temperature_sensor/client_behaviors/cb_custom_condition_temperature_sensor.hpp>

#include <sm_dance_bot_warehouse_4/clients/cl_service3/client_behaviors/cb_service3.hpp>
#include <sm_dance_bot_warehouse_4/clients/cl_string_publisher/client_behaviors/cb_string_publisher.hpp>
...
using namespace sm_dance_bot_warehouse_4::cl_lidar;
using namespace sm_dance_bot_warehouse_4::cl_service3;
using namespace sm_dance_bot_warehouse_4::cl_string_publisher;
using namespace sm_dance_bot_warehouse_4::cl_temperature_sensor;
using namespace sm_dance_bot_warehouse_4::cl_led;
...
// ORTHOGONALS
#include <sm_dance_bot_warehouse_4/orthogonals/or_led.hpp>
#include <sm_dance_bot_warehouse_4/orthogonals/or_navigation.hpp>
#include <sm_dance_bot_warehouse_4/orthogonals/or_obstacle_perception.hpp>
#include <sm_dance_bot_warehouse_4/orthogonals/or_service3.hpp>
#include <sm_dance_bot_warehouse_4/orthogonals/or_string_publisher.hpp>
#include <sm_dance_bot_warehouse_4/orthogonals/or_temperature_sensor.hpp>
#include <sm_dance_bot_warehouse_4/orthogonals/or_timer.hpp>
#include <sm_dance_bot_warehouse_4/orthogonals/or_updatable_publisher.hpp>

namespace sm_dance_bot_warehouse_4
{
...
using namespace sm_dance_bot_warehouse_4;
...
struct SmDanceBotWarehouse4 : public smacc2::SmaccStateMachineBase<SmDanceBotWarehouse4, MsDanceBotRunMode>
{
  int counter_1;
  bool rt_ready_flag;
...
//MODE STATES
#include <sm_dance_bot_warehouse_4/modestates/ms_dance_bot_run_mode.hpp>

#include <sm_dance_bot_warehouse_4/modestates/ms_dance_bot_recovery_mode.hpp>

//SUPERSTATES
#include <sm_dance_bot_warehouse_4/superstates/ss_radial_pattern_1.hpp>

//STATES
#include <sm_dance_bot_warehouse_4/states/st_acquire_sensors.hpp>
