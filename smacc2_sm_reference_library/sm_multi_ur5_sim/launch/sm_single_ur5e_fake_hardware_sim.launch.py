...
def launch_setup(context, *args, **kwargs):
    ...
    robot_description_kinematics = PathJoinSubstitution(
        [FindPackageShare("sm_multi_ur5_sim"), "config", "moveit", "kinematics.yaml"]
    )
    ...
    smacc2_sm_config = PathJoinSubstitution(
        [
            ...
            "config",
            "sm_multi_ur5_sim.yaml",
        ]
    )

    sm_multi_ur5_sim_node = Node(
    ...
    ur_control_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [FindPackageShare("sm_multi_ur5_sim"), "/launch", "/single_ur_control_fake.launch.py"]
        ),
        launch_arguments={
