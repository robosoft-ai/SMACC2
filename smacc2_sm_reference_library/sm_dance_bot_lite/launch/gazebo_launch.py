...
def generate_launch_description():
    ...
    launch_dir = os.path.join(sm_dance_bot_lite_dir, "launch")
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        # default_value=os.path.join(sm_dance_bot_lite_dir, 'worlds', 'waffle.model'),
        # default_value=os.path.join(sm_dance_bot_lite_dir, 'worlds', 'sm_dance_bot_lite_world.model'),
        default_value=os.path.join(sm_dance_bot_lite_dir, "worlds", "ridgeback_race.world"),
