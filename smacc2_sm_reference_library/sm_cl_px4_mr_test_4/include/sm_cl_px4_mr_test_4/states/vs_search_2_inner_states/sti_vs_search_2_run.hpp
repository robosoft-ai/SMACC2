...
// INNER STATE: run sector search #2 at the pin, then return to StRailway
struct StiVSSearch2Run : smacc2::SmaccState<StiVSSearch2Run, SsVSSearch2>
{
  ...
  void runtimeConfigure()
  {
    ...
    const auto & params = this->context<SsVSSearch2>().params;
    ...
    RCLCPP_INFO(
      getLogger(), "StiVSSearch2Run: pin '%s' NED (%.1f, %.1f)", pin.name.c_str(),
