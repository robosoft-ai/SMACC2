...
// INNER STATE: run sector search #3 at the pin, then return to StRailway
struct StiVSSearch3Run : smacc2::SmaccState<StiVSSearch3Run, SsVSSearch3>
{
  ...
  void runtimeConfigure()
  {
    ...
    const auto & params = this->context<SsVSSearch3>().params;
    ...
    RCLCPP_INFO(
      getLogger(), "StiVSSearch3Run: pin '%s' NED (%.1f, %.1f)", pin.name.c_str(),
