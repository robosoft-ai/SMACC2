...
struct StConnectMicroROSAgent : smacc2::SmaccState<StConnectMicroROSAgent, MsDisarmedOnGround>
{
  ...
  void onExit()
  {
    RCLCPP_INFO(getLogger(), "StConnectMicroROSAgent: micro_ros_agent connected");
  }
};
