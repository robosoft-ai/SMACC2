...
// SUPERSTATE: Victor Sierra sector search #1 at its pin. The three VS
...
struct SsVSSearch1 : smacc2::SmaccState<SsVSSearch1, MsInFlight, StiVSSearch1Run>
{
  ...
  struct Params
  {
    cl_px4_mr::FlightPatternVSSearchParams pattern = railway::vsSearchParams(1);
  ...
  {
    RCLCPP_INFO(
      getLogger(), "=== SsVSSearch1: sector search, r=%.0f m, first leg %.0f deg, ~%.0f m ===",
