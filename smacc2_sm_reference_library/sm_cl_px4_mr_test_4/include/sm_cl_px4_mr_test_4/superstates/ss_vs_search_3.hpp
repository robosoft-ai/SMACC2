...
// SUPERSTATE: Victor Sierra sector search #3 at its pin. The three VS
...
struct SsVSSearch3 : smacc2::SmaccState<SsVSSearch3, MsInFlight, StiVSSearch3Run>
{
  ...
  struct Params
  {
    cl_px4_mr::FlightPatternVSSearchParams pattern = railway::vsSearchParams(3);
  ...
  {
    RCLCPP_INFO(
      getLogger(), "=== SsVSSearch3: sector search, r=%.0f m, first leg %.0f deg, ~%.0f m ===",
