...
private:
    ...
    void pureSpinningCmd(const geometry_msgs::msg::PoseStamped & pose, double vetta, double gamma, double alpha_error, double betta_error, double rho_error, geometry_msgs::msg::Twist &cmd_vel);
    void defaultBackwardCmd(const geometry_msgs::msg::PoseStamped &pose, double vetta, double gamma, double alpha_error,double betta_error, geometry_msgs::msg::Twist &cmd_vel);
